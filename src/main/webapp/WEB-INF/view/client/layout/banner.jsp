    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-5">
                <h4 class="mb-3 text-info">100% Sản Phẩm Chính Hãng</h4>
                <h1 class="mb-5 display-3 text-danger">Hàng cao cấp<br/> Rẻ vô địch</h1>
            </div>
                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item ">
                            <img src="/client/img/2.jpg" class="img-fluid  rounded"
                                 alt="Second slide">
                        ...
                        <div class="carousel-item ">
                             <img src="/client/img/8.jpg" class="img-fluid  rounded"
                                  alt="Second slide">
