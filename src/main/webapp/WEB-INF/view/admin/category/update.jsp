                ...
                <div class="mt-5">
                    <div class="row">
                        <div class="col-12 mx-auto">
                            ...
                            <hr />
                            <label class="ms-4">Tên: ${category1.name}</label>
                            <form:form class="form p-3" action="/admin/category/update/${category1.categoryId}" method="post" modelAttribute="newCate">
                                <!-- Name input -->
                                ...
                                <div class="d-flex justify-content-center">
                                    <button class="btn btn-warning btn-block mb-3">Cập nhật</button>
                                </div>
                            </form:form>
